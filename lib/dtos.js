...
dtos.RequirementsPendingMembership = {
  type: String,
  blockstamp: String,
  sig: String
};
...
dtos.Requirements = {
  "identities": [{
    ...
    pendingCerts: [dtos.RequirementsPendingCert],
    pendingMemberships: [dtos.RequirementsPendingMembership],
