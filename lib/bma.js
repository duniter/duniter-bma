...
module.exports = function(server, interfaces, httpLogs, logger) {
  ...
  return network.createServersAndListen('Duniter server', server, interfaces, httpLogs, logger, null, (app, httpMethods) => {
    ...
    httpMethods.httpGET(  '/',                                      node.summary,                         dtos.Summary,        limiter.limitAsHighUsage());
    httpMethods.httpGET(  '/node/summary',                          node.summary,                         dtos.Summary,        limiter.limitAsHighUsage());
    httpMethods.httpGET(  '/node/sandboxes',                        node.sandboxes,                       dtos.Sandboxes,      limiter.limitAsHighUsage());
    ...
    httpMethods.httpGET(  '/wot/pending',                           wot.pendingMemberships,               dtos.MembershipList, limiter.limitAsHighUsage());
    httpMethods.httpGET(  '/wot/requirements/:search',              wot.requirements,                     dtos.Requirements,   limiter.limitAsHighUsage());
    httpMethods.httpGET(  '/wot/requirements-of-pending/:minsig',   wot.requirementsOfPending,            dtos.Requirements,   limiter.limitAsLowUsage());
    ...
    httpMethods.httpGET(  '/tx/hash/:hash',                         transactions.getByHash,               dtos.Transaction,    limiter.limitAsHighUsage());
