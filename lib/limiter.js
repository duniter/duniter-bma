...
let LOW_USAGE_STRATEGY = Object.create(Limiter);
LOW_USAGE_STRATEGY.limitPerSecond = 1;
LOW_USAGE_STRATEGY.limitPerMinute = 30;
...
module.exports = {
  ...
  limitAsLowUsage() {
    return disableLimits ? createObject(NO_LIMIT_STRATEGY) : createObject(LOW_USAGE_STRATEGY);
  },
